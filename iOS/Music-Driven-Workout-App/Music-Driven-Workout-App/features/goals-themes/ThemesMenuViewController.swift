...
class ThemesMenuViewController: UITableViewController {
    ...
    @IBAction func testPopulateThemes(_ sender: UIButton) {
        print("testing populate themes")
        populateThemes()
    }
    
}
extension ThemesMenuViewController {
